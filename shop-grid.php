...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/office-stationery-500x500.jpg">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="img/banner/banner-1.jpg" style="width: 110px; height: 110px;" alt="">
                                            </div>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="filter__item">
                        ...
                        <div class="filter__found">
                            <h6 style="color: green;"><span>16</span> Products found</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/banner/banner-1.jpg">
                                    <ul class="product__item__pic__hover">
